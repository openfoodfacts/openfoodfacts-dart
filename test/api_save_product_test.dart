...
void main() {
  ...
  group(
    '$OpenFoodAPIClient add new products',
    () {
      ...
      test('dont overwrite language', () async {
        ...
        final ProductQueryConfiguration germanConfig =
            ProductQueryConfiguration(
              barcode,
 ...
 */
      ...
      test('add new product test 6', () async {
        ...
        expect(result.product!.labelsTags, [
          'en:product-labels-test-1',
          'en:product-labels-test-2',
        ]);
        expect(
      ...
      test('Invalid user saves product', () async {
        Product product = Product(barcode: '7340011364184');
        Status status = await OpenFoodAPIClient.saveProduct(
          User(userId: 'invaliduser', password: generateRandomString(16)),
          product,
          uriHelper: uriHelper,
        );
      ...
      test('get+update+get calcium', () async {
