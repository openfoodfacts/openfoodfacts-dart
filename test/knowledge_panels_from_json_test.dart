...
void main() {
  ...
  test('Load knowledge panel JSON with a text element', () {
    ...
    expect(kp.panelIdToPanelMap[id]!.elements!.length, equals(1));
    expect(
      kp.panelIdToPanelMap[id]!.elements!.first.elementType,
      equals(KnowledgePanelElementType.TEXT),
    );
    expect(kp.panelIdToPanelMap[id]!.elements!.first.textElement, isNotNull);
    expect(
  ...
  test('Load knowledge panel JSON with an action element', () {
    ...
    expect(kp.panelIdToPanelMap[id]!.elements!.first.actionElement, isNotNull);
    expect(
