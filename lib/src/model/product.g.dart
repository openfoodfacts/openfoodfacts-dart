          ...
          (json['imagesFreshnessInLanguages'] as Map<String, dynamic>?)?.map(
            (k, e) => MapEntry(
              ...
              (e as Map<String, dynamic>).map(
                (k, e) => MapEntry(
                  $enumDecode(_$ImageFieldEnumMap, k),
                  (e as num).toInt(),
                ),
              ),
            ),
...
Map<String, dynamic> _$ProductToJson(Product instance) => <String, dynamic>{
  ...
  if (LanguageHelper.toJsonStringMap(instance.conservationConditionsInLanguages)
      case final value?)
  ...
  if (instance.packagingQuantity case final value?) 'product_quantity': value,
  ...
  if (LanguageHelper.toJsonStringsListMap(instance.ingredientsTagsInLanguages)
      case final value?)
    'ingredients_tags_in_languages': value,
  'imagesFreshnessInLanguages': instance.imagesFreshnessInLanguages?.map(
    (k, e) => MapEntry(
      _$OpenFoodFactsLanguageEnumMap[k]!,
  ...
  if (instance.nutrimentDataPer case final value?) 'nutrition_data_per': value,
  ...
  if (LanguageHelper.toJsonStringsListMap(instance.categoriesTagsInLanguages)
      case final value?)
  ...
  if (JsonHelper.productPackagingsToJson(instance.packagings) case final value?)
    'packagings': value,
  ...
  if (instance.lastCheckDates case final value?) 'last_check_dates_tags': value,
  if (instance.lastEditDates case final value?) 'last_edit_dates_tags': value,
  if (instance.lastImageDates case final value?) 'last_image_dates_tags': value,
  ...
  if (EcoscoreData.toJsonHelper(instance.ecoscoreData) case final value?)
    'ecoscore_data': value,
  if (KnowledgePanels.toJsonHelper(instance.knowledgePanels) case final value?)
  ...
  if (instance.dataQualityTags case final value?) 'data_quality_tags': value,
