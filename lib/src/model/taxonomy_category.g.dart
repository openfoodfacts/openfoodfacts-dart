...
Map<String, dynamic> _$TaxonomyCategoryToJson(
  TaxonomyCategory instance,
) => <String, dynamic>{
  'agribalyse_food_code': ?LanguageHelper.toJsonStringMap(
    instance.agribalyseFoodCode,
  ),
  'agribalyse_food_name': ?LanguageHelper.toJsonStringMap(
    instance.agribalyseFoodName,
  ),
  'agribalyse_proxy_food_code': ?LanguageHelper.toJsonStringMap(
    instance.agribalyseProxyFoodCode,
  ),
  'agribalyse_proxy_food_name': ?LanguageHelper.toJsonStringMap(
    instance.agribalyseProxyFoodName,
  ),
  'agribalyse_proxy_name': ?LanguageHelper.toJsonStringMap(
    instance.agribalyseProxyName,
  ),
  ...
  'ciqual_proxy_food_code': ?LanguageHelper.toJsonStringMap(
    instance.ciqualProxyFoodCode,
  ),
  'ciqual_proxy_food_name': ?LanguageHelper.toJsonStringMap(
    instance.ciqualProxyFoodName,
  ),
  ...
  'protected_name_file_number': ?LanguageHelper.toJsonStringMap(
    instance.protectedNameFileNumber,
  ),
  'protected_name_type': ?LanguageHelper.toJsonStringMap(
    instance.protectedNameType,
  ),
  'region': ?LanguageHelper.toJsonStringMap(instance.region),
  'season_in_country_fr': ?LanguageHelper.toJsonStringMap(
    instance.seasonInCountryFr,
  ),
  'who_id': ?LanguageHelper.toJsonStringMap(instance.whoId),
  'wikidata': ?LanguageHelper.toJsonStringMap(instance.wikidata),
  'wikidata_category': ?LanguageHelper.toJsonStringMap(
    instance.wikidataCategory,
  ),
  'wikidata_wikipedia_category': ?LanguageHelper.toJsonStringMap(
    instance.wikidataWikipediaCategory,
  ),
};
