...
// TODO (Optional) Add Nutri-Score disclaimers cf. https://github.com/openfoodfacts/openfoodfacts-dart/issues/193
  ...
  Product copyWith({
    ...
    List<String>? ingredientsTags,
    Map<OpenFoodFactsLanguage, List<String>>? ingredientsTagsInLanguages,
    Map<OpenFoodFactsLanguage, Map<ImageField, int>>?
    ...
    return Product(
      ...
      productNameInLanguages:
          productNameInLanguages ?? this.productNameInLanguages,
      genericName: genericName ?? this.genericName,
      brands: brands ?? this.brands,
      brandsTags: brandsTags ?? this.brandsTags,
      countries: countries ?? this.countries,
      countriesTags: countriesTags ?? this.countriesTags,
      countriesTagsInLanguages:
          countriesTagsInLanguages ?? this.countriesTagsInLanguages,
      lang: lang ?? this.lang,
      ...
      imageIngredientsSmallUrl:
          imageIngredientsSmallUrl ?? this.imageIngredientsSmallUrl,
      ...
      imagePackagingUrl: imagePackagingUrl ?? this.imagePackagingUrl,
      imagePackagingSmallUrl:
          imagePackagingSmallUrl ?? this.imagePackagingSmallUrl,
      servingSize: servingSize ?? this.servingSize,
      servingQuantity: servingQuantity ?? this.servingQuantity,
      packagingQuantity: packagingQuantity ?? this.packagingQuantity,
      selectedImages: selectedImages ?? this.selectedImages,
      images: images ?? this.images,
      ingredients: ingredients ?? this.ingredients,
      ingredientsText: ingredientsText ?? this.ingredientsText,
      ingredientsTextInLanguages:
          ingredientsTextInLanguages ?? this.ingredientsTextInLanguages,
      ingredientsTags: ingredientsTags ?? this.ingredientsTags,
      ingredientsTagsInLanguages:
          ingredientsTagsInLanguages ?? this.ingredientsTagsInLanguages,
      ingredientsAnalysisTags:
          ingredientsAnalysisTags ?? this.ingredientsAnalysisTags,
      additives: additives ?? this.additives,
      allergens: allergens ?? this.allergens,
      nutrientLevels: nutrientLevels ?? this.nutrientLevels,
      nutrimentEnergyUnit: nutrimentEnergyUnit ?? this.nutrimentEnergyUnit,
      nutrimentDataPer: nutrimentDataPer ?? this.nutrimentDataPer,
      nutriscore: nutriscore ?? this.nutriscore,
      categories: categories ?? this.categories,
      categoriesTags: categoriesTags ?? this.categoriesTags,
      categoriesTagsInLanguages:
          categoriesTagsInLanguages ?? this.categoriesTagsInLanguages,
      labels: labels ?? this.labels,
      labelsTags: labelsTags ?? this.labelsTags,
      labelsTagsInLanguages:
          labelsTagsInLanguages ?? this.labelsTagsInLanguages,
      packaging: packaging ?? this.packaging,
      packagingTags: packagingTags ?? this.packagingTags,
      miscTags: miscTags ?? this.miscTags,
      statesTags: statesTags ?? this.statesTags,
      tracesTags: tracesTags ?? this.tracesTags,
      storesTags: storesTags ?? this.storesTags,
      ...
      ecoscoreData: ecoscoreData ?? this.ecoscoreData,
      nutriments: _nutriments,
