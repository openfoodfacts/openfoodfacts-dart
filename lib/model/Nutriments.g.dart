...
Nutriments _$NutrimentsFromJson(Map<String, dynamic> json) {
  return Nutriments(
    ...
    phosphorusUnit: UnitHelper.stringToUnit(json['phosphorus_unit'] as String),
    ...
    vitaminB12Unit: UnitHelper.stringToUnit(json['vitamin-b12_unit'] as String),
    ...
    capricAcidUnit: UnitHelper.stringToUnit(json['capric-acid_unit'] as String),
    ...
    caprylicAcidServing: JsonObject.parseDouble(json['caprylic-acid_serving']),
    caprylicAcidUnit:
    ...
    myristicAcidServing: JsonObject.parseDouble(json['myristic-acid_serving']),
    myristicAcidUnit:
    ...
    oleicAcidUnit: UnitHelper.stringToUnit(json['oleic-acid_unit'] as String),
    palmiticAcid: JsonObject.parseDouble(json['palmitic-acid_100g']),
    palmiticAcidServing: JsonObject.parseDouble(json['palmitic-acid_serving']),
    palmiticAcidUnit:
...
Map<String, dynamic> _$NutrimentsToJson(Nutriments instance) {
  ...
  writeNotNull('docosahexaenoic-acid_unit',
      _$UnitEnumMap[instance.docosahexaenoicAcidUnit]);
  writeNotNull(
  ...
  writeNotNull('eicosapentaenoic-acid_unit',
      _$UnitEnumMap[instance.eicosapentaenoicAcidUnit]);
  writeNotNull('erucic-acid_serving', instance.erucicAcidServing);
  writeNotNull('erucic-acid_100g', instance.erucicAcid);
  writeNotNull('erucic-acid_unit', _$UnitEnumMap[instance.erucicAcidUnit]);
  ...
  writeNotNull(
      'monounsaturated_unit', _$UnitEnumMap[instance.monounsaturatedUnit]);
